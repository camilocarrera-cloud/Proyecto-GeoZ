...
class Personaje:
    ...
    def infectar(self):
        """Marca al civil como infectado"""
        self.estado = True
        self.turnos_infeccion = 3

    def avanzar_turno(self):
        """Reduce el contador de infección si está infectado"""
    ...
    def morir(self):
        """El civil muere si no es curado a tiempo"""
        self.con_vida = False
...
class Atacante(Civil):
    ...
    def esquivar(self):
        """Evita todos los ataques durante 5 segundos"""
        self.estado = "esquivando"
        # Podrías usar un sistema de turnos para contar duración
...
class Defensor(Civil):
     ...
     def bloquear(self):
        """Bloquea todos los ataques durante 8 segundos"""
...
class Productor(Civil):
    ...
    def duplicar_recoleccion(self):
        """Duplica los recursos recolectados durante 3 turnos"""
        self.estado = "recolectando_doble"
...
class Cientifico(Civil):
     def __init__(self, vida:int, ataque:int, defensa:float, velocidad:float, categoria:str, habilidad:str, estado:bool, energia:int, posicion_x:int, posicion_y:int, con_vida = bool):
        ...
        self.posicion_x = posicion_x
        self.posicion_y = posicion_y
     def reducir_tiempo_espera(self):
        """Reduce el tiempo de espera para curación"""
        self.estado = "reduccion_activa"
...
class Medico(Civil):
    ...
    def curar(self, civil:Civil):
        ...
        if civil.infectado and civil.con_vida:
            civil.infectado = False
...
class Zombie(Personaje):
    def __init__(self, vida:int, ataque:int, defensa:float, velocidad:float, categoria:str, habilidad:str, estado:bool, energia:int, color:str, posicion_x:int, posicion_y:int, con_vida:bool=True):
        # inicializa atributos comunes desde Personaje
        super().__init__(vida, ataque, defensa, velocidad, categoria, habilidad, estado, posicion_x, posicion_y, energia)
...
class Verde(Zombie):
    def __init__(self, posicion_x:int, posicion_y:int):
        super().__init__(vida=100, ataque=40, defensa=100*0.2, velocidad=3.5, categoria="Normal", habilidad="Escupir", estado=True, energia=80, color="Verde",
                         posicion_x=posicion_x, posicion_y=posicion_y, con_vida=True)

class Morado(Zombie):
    def __init__(self, posicion_x:int, posicion_y:int):
        super().__init__(vida=150, ataque=30, defensa=150*0.5, velocidad=2.0, categoria="Tanque", habilidad="Aplastar", estado=True, energia=100, color="Morado",
                         posicion_x=posicion_x, posicion_y=posicion_y, con_vida=True)

class Amarillo(Zombie):
    def __init__(self, posicion_x:int, posicion_y:int):
        super().__init__(vida=80, ataque=50, defensa=80*0.1, velocidad=5.5, categoria="Veloz", habilidad="Doble ataque", estado=True, energia=60, color="Amarillo", 
                         posicion_x=posicion_x, posicion_y=posicion_y, con_vida=True)
...
c1 = CivilNormal(0,0,0,0,"","",True,0,10,10)
c1.infectar()

m1 = Medico(0,0,0,0,"","",True,0,11,10)
m1.curar(c1)

print(c1.infectado)         # False
